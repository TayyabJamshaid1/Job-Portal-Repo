...
import { UpdateEmployerProfile } from "@/lib/EmployerActions";
import { useMutation } from "@tanstack/react-query";
import { queryClient } from "./Providers";
import { toast } from "react-toastify";
import {
  EmployerProfileData,
  EmployerProfileInitialData,
...
const EmployerSettingsForm = ({ initialData }: {   initialData: EmployerProfileInitialData;
  ...
  const {
    mutate: updateEmployerProfileData,
    isPending,
    variables,
    isError,
  } = useMutation({
  ...
  const handleFormSubmit = async (data: EmployerProfileData) => {
    ...
    let updatedData = {
      ...data,
      employerId: initialData._id.toString(),
    };
     updateEmployerProfileData(updatedData);
  };
